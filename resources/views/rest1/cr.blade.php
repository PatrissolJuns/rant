      ...
      <div class="container">
        <div class="row">
          <div class="col-md-7 mb-5"  data-aos="fade">
            ...
            {!! Form::open(['route'=>'rest1.store', 'class'=>'p-5 bg-white']) !!}
              ...
              <div class="row form-group {!! $errors->has('quartier') ? 'has-errors' : '' !!}">
                
                <div class="col-md-12">
                  <label class="text-black" for="email">Image</label> 
                  <input type="text" id="email" class="form-control" name="image">
                </div>
              </div>
