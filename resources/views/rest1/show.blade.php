...
<div class="site-blocks-cover inner-page-cover overlay" style="background-image: url('../{!! $rest1->image !!}');" data-aos="fade" data-stellar-background-ratio="0.5">
      <div class="container">
          ...
          <div class="col-md-10" data-aos="fade-up" data-aos-delay="400">
            ...
            <div class="row justify-content-center">
              <div class="col-md-8 text-center">
                <h1>{!! $rest1->nom !!}</h1>
                <p class="mb-0">{!! $rest1->immeuble !!}, {!! $rest1->rue !!}, {!! $rest1->quartier !!}</p>
              </div>
            </div>
        ...
        <div class="row">
          <div class="col-lg-8">
            ...
            <div class="mb-5 border-bottom pb-5">
              <img src="../{!! $rest1->image !!}" alt="Image" class="img-fluid mb-4">

              <div class="row mb-5">
                <div class="col-md-6">
                  <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Fugit numquam expedita, exercitationem harum magni natus, mollitia, similique itaque quasi, accusamus ipsa dignissimos eos. Porro in expedita rerum nam? Voluptas, porro!</p>
                  
                </div>
                <div class="col-md-6">
                  <p>Laboriosam molestiae exercitationem eos, tempore repellendus, assumenda reprehenderit sequi accusamus aut quidem animi quis inventore ipsam ab perspiciatis, nemo? Voluptatum minus sed, temporibus quisquam cum exercitationem animi debitis perferendis perspiciatis.</p>
                </div>
              </div>

              <div class="row">
                <div class="col-md-6">
                  <a href="#" class="btn btn-primary rounded px-4 py-3">Reserver</a>
                </div>
              </div>
            </div>
